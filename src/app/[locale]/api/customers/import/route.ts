// src/app/[locale]/api/customers/import/route.ts
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const expectedHeaders = ["Name", "Email", "Phone", "Status"];
    ...
    // ✅ Update user's last activity after successful import
    if (successCount > 0 || errorCount > 0) {
      // Even if some errors, user performed an action
