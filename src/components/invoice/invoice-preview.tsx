      ...
      <div ref={ref}>
        <Card className={cardPadding}>
          <div className="mb-6 border-b pb-4">
            ...
            <h2 className={`${headerTextSize} font-bold mb-2`}>
              {t("invoiceTitle")}
            </h2>
          ...
          <div className="border-t pt-4 space-y-2">
            ...
            requestCustomerSignature ? (
              <div
                className={`mt-6 flex ${isThermal ? "flex-col gap-4" : "justify-between items-end gap-6"}`}
              >
                {signatureImage && includeSignature && (
                ...
                {requestCustomerSignature && (
                  <div className="flex flex-col items-end gap-2 flex-1">
                    <div
                      className={`${signatureHeight} ${isThermal ? "w-full" : "w-48"} border-2 border-dashed border-gray-300 flex items-center justify-center`}
                    >
                      <span className="text-xs text-muted-foreground">
                        {t("customerSignature")}
                      </span>
